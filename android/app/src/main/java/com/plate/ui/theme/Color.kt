...
// secondary=blue, tertiary=violet. Green is PULSE's recovery/fresh channel; blue steps back to a
// supporting role (still the carbs data channel via Pulse.kt).
val LightPrimary = Color(0xFF047857)
val LightOnPrimary = Color(0xFFFFFFFF)
val LightPrimaryContainer = Color(0xFFD8F3E8)
val LightOnPrimaryContainer = Color(0xFF02382A)
val LightSecondary = Color(0xFF2A5BFF)
val LightOnSecondary = Color(0xFFFFFFFF)
val LightSecondaryContainer = Color(0xFFDEE7FF)
val LightOnSecondaryContainer = Color(0xFF0A2078)
...
// Dark theme — channel hues sit directly on the ink/panel surfaces. Green leads (primary); the
// on-primary is a deep green ink because white fails contrast on the bright green (see Pulse.kt).
val DarkPrimary = Color(0xFF34D399)
val DarkOnPrimary = Color(0xFF00301F)
val DarkPrimaryContainer = Color(0xFF11332A)
val DarkOnPrimaryContainer = Color(0xFFB9F2DC)
val DarkSecondary = Color(0xFF4D7CFF)
val DarkOnSecondary = Color(0xFFFFFFFF)
val DarkSecondaryContainer = Color(0xFF1B2440)
val DarkOnSecondaryContainer = Color(0xFFD6E0FF)
