...
/**
 * The data display scale — monospace for every numeral in the app (calories, macros, weights,
 ...
 * its own voice, not a heading. Pull via `PlateTheme.dataType`.
 */
@Immutable
