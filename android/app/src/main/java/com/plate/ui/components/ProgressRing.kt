...
import com.plate.ui.theme.PulseMotion

/**
 * The instrument-panel ring: a hairline track with a round-capped channel arc and an optional soft
 * glow behind the arc. Center is a slot — put a [DataText] readout in it. Mirrors Spotter's PULSE
 * `ProgressRing`, defaulting to Plate's calories (strength violet) channel.
 */
@Composable
fun ProgressRing(
    progress: Float,
    modifier: Modifier = Modifier,
    channel: Color = PlateTheme.pulse.calories,
    strokeWidth: Dp = 8.dp,
    glow: Boolean = true,
